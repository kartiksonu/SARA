...
def movebase_client():
   ...
   # Creates a new goal with the MoveBaseGoal constructor
    ...
    # caffeteria position                     
    goal.target_pose.pose.position.x = 27.07848
    goal.target_pose.pose.position.y = 21.70707
    goal.target_pose.pose.position.z = 0.0
    goal.target_pose.pose.orientation.x = 0.0
    goal.target_pose.pose.orientation.y = 0.0
    goal.target_pose.pose.orientation.z = 0.71103389
    goal.target_pose.pose.orientation.w = 0.703157736458
