...
def callback(data):
    ...
    saber.text('1,start')
    saber.text('2,start')
    saber.text('1, UNITS 377 inch = 3600 lines') # 377 = 3600
    saber.text('2, UNITS 377 inch = 3600 lines')
    saber.text('1,home')
    saber.text('2,home')

    # saber.text('1, UNITS 958 mm')
    # saber.text('S1: get\r\n')
    ...
    #saber.drive(1,speed)
    #saber.drive(2,speed)
    # m1 = saber.textGet('S1:get').split()[1]
    m1 = saber.textGet('1:gets')
    m2 = saber.textGet('2,gets')
    ...
    if(angle > 0):
        print "right"
        saber.drive(1, speed + speed1)
        saber.drive(2, speed + speed2)
    elif (angle < 0):
        print "left"
        saber.drive(1, speed + speed1)
        saber.drive(2, speed + speed2)
